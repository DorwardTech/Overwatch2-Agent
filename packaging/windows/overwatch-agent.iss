...
;
;   Expand-Archive overwatch-agent_1.5.1_windows_amd64.zip -DestinationPath stage\amd64
;   Expand-Archive overwatch-agent_1.5.1_windows_arm64.zip -DestinationPath stage\arm64
;
; both run from the repository root, which is what SourceDir below anchors to:
;
;   & "C:\Program Files (x86)\Inno Setup 6\ISCC.exe" `
;       /DAppVersion=1.5.1 `
;       /DAmd64Dir=stage\amd64\overwatch-agent_1.5.1_windows_amd64 `
;       /DArm64Dir=stage\arm64\overwatch-agent_1.5.1_windows_arm64 `
